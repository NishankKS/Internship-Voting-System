...
<!-- /.modal-content -->
	...
	<?php 
		...
		if(ISSET($_POST['update'])){
			...
			$conn->query("UPDATE candidate SET Category = '$position', firstname = '$firstname', lastname = '$lastname', Age = '$age', gender = '$gender',img='$location' WHERE candidate_id = '$candidate_id'")or die($conn->error);
